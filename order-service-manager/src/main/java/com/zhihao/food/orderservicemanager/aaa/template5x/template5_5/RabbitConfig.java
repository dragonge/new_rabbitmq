package com.zhihao.food.orderservicemanager.aaa.template5x.template5_5;
...
public class RabbitConfig {
    ...
    @Autowired
    public void startListenMessage() throws IOException, TimeoutException, InterruptedException, TimeoutException {
